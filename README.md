...
**Modelos:** producto.py contiene la clase Producto y cliente.py contiene la clase Cliente
**Servicios:** restaurante.py que contiene la clase Restaurante encargada de gstionar los productos y clientes.
**Archivo principal:** main.py que permite crear objetos y ejecuta el sistema
**Conceptos de POO aplicados:** Clases y objetos, contrustores (init), atributos, métodos, método esecial str(), importanción de módulos y organización modular.

**Reflexión:** La modularización permite organizar mejor el código, separar responsabilidades y facilitar el mantenimiento del programa. Gracias a esta estructura considerando los demás alcances de la POO, cada clase cumple un afunción y el proyecto resulta más sencillo de analizar y mantener más adelante. 